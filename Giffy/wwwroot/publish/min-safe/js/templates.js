angular.module('Giffy').run(['$templateCache', function($templateCache) {
  'use strict';
  ...
  $templateCache.put('wwwroot/app/template/footer.html',
    "Copyright &copy; 2015 Giffy<ul class=\"f-menu\"><li><a href=\"\" data-ui-sref=\"pages.wall\" data-ng-click=\"tcmsctrl.sidebarStat($event)\">Home</a></li><li><a href=\"\" data-ui-sref=\"pages.league\" data-ng-click=\"tcmsctrl.sidebarStat($event)\">Leagues</a></li><li><a href=\"\" data-ui-sref=\"pages.team\" data-ng-click=\"tcmsctrl.sidebarStat($event)\">Teams</a></li><li><a href=\"\" data-ui-sref=\"pages.player\" data-ng-click=\"tcmsctrl.sidebarStat($event)\">Players</a></li></ul>"
  );


  $templateCache.put('wwwroot/app/template/header.html',
    "<ul class=\"header-inner\"><li class=\"logo\" data-ng-class=\"{ 'open': tcmsctrl.sidebarToggle.left === true }\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'',slug:''})\"><div class=\"logo-button\"></div></a></li><li class=\"menu hidden-xs p-l-15 p-r-15\" data-target=\"mainmenu\" data-toggle-sidebar data-model-left=\"tcmsctrl.sidebarToggle.left\"><a href=\"\"><i class=\"zmdi zmdi-menu f-25\"></i></a></li><li class=\"menu hidden-xs\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'image',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-image-o\"></i> <span class=\"hidden-xs p-l-5\">Image</span></a></li><li class=\"menu hidden-xs\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'gif',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-collection-image-o\"></i> <span class=\"hidden-xs p-l-5\">Gif</span></a></li><li class=\"menu hidden-xs\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'video',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-tv-play\"></i> <span class=\"hidden-xs p-l-5\">Video</span></a></li><li class=\"menu pull-right-start\"></li><li class=\"menu\"><a href=\"\" data-ng-click=\"hctrl.openSearch();\"><i class=\"zmdi zmdi-search f-25\"></i></a></li><li class=\"menu\" data-ng-if=\"!tcmsctrl.authentication.isAuth\"><a href=\"\" data-ng-click=\"hctrl.showLoginForm();\"><i class=\"zmdi zmdi-lock-outline f-22\"></i></a></li><li class=\"menu hidden-sm hidden-md hidden-lg\" data-ng-if=\"tcmsctrl.authentication.isAuth\"><a href=\"\" data-ng-click=\"hctrl.showPostingForm();\"><i class=\"zmdi zmdi-plus f-22\"></i></a></li><li class=\"menu hidden-sm hidden-md hidden-lg\"><a href=\"\" data-target=\"mainmenu\" data-toggle-sidebar data-model-left=\"tcmsctrl.sidebarToggle.left\"><i class=\"zmdi zmdi-menu f-22\"></i></a></li><li class=\"menu m-r-5\"></li><!--<li class=\"pull-right\">\r" +
    "\n" +
    "        <ul class=\"top-menu\">\r" +
    "\n" +
    "\r" +
    ...
    "\n" +
    "                    <input id=\"tw-switch\" type=\"checkbox\" hidden=\"hidden\" data-change-layout=\"tcmsctrl.layoutType\">\r" +
    "\n" +
    ...
    "        </li>\r" +
    "\n" +
    "        </ul>--></ul><ul class=\"sub-header-inner hidden-sm hidden-md hidden-lg\"><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'image',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-image-o\"></i> <span class=\"p-l-5\">Image</span></a></li><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'gif',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-collection-image-o\"></i> <span class=\"p-l-5\">Gif</span></a></li><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'video',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-tv-play\"></i> <span class=\"p-l-5\">Video</span></a></li></ul><!-- Top Search Content --><div id=\"top-search-wrap\"><input type=\"text\" enter-key=\"hctrl.search()\" data-ng-model=\"hctrl.searchText\"> <i id=\"top-search-close\" data-ng-click=\"hctrl.closeSearch()\">&times;</i></div><script type=\"text/ng-template\" id=\"loginForm\"><!-- Login -->\r" +
    "\n" +
  ...
  $templateCache.put('wwwroot/app/template/management-header.html',
    "<ul class=\"header-inner\"><li class=\"logo\" data-ng-class=\"{ 'open': tcmsctrl.sidebarToggle.left === true }\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'',slug:''})\"><div class=\"logo-button\"></div></a></li><li class=\"menu hidden-xs p-l-15 p-r-15\" data-target=\"mainmenu\" data-toggle-sidebar data-model-left=\"tcmsctrl.sidebarToggle.left\"><a href=\"\"><i class=\"zmdi zmdi-menu f-25\"></i></a></li><li class=\"menu hidden-sm hidden-md hidden-lg\"><a href=\"\" data-target=\"mainmenu\" data-toggle-sidebar data-model-left=\"tcmsctrl.sidebarToggle.left\"><i class=\"zmdi zmdi-menu f-22\"></i></a></li><li class=\"menu m-r-5\"></li></ul><ul class=\"sub-header-inner hidden-sm hidden-md hidden-lg\"><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'image',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-image-o\"></i> <span class=\"p-l-5\">Image</span></a></li><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'gif',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-collection-image-o\"></i> <span class=\"p-l-5\">Gif</span></a></li><li class=\"menu\" data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall({filter:'video',slug:''})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-tv-play\"></i> <span class=\"p-l-5\">Video</span></a></li></ul><!-- Top Search Content --><div id=\"top-search-wrap\"><input type=\"text\" enter-key=\"hctrl.search()\" data-ng-model=\"hctrl.searchText\"> <i id=\"top-search-close\" data-ng-click=\"hctrl.closeSearch()\">&times;</i></div><script type=\"text/ng-template\" id=\"loginForm\"><!-- Login -->\r" +
    "\n" +
    "    <div data-ng-controller=\"loginCtrl as lctrl\">\r" +
    "\n" +
    "        <form name=\"LoginForm\" class=\"lc-block lc-form\" id=\"l-login\" data-ng-class=\"{ 'toggled': loginTab }\" data-ng-if=\"loginTab\">\r" +
  ...
  $templateCache.put('wwwroot/app/template/management-sidebar.html',
    "<div class=\"sidebar-inner c-overflow\"><div data-ng-if=\"tcmsctrl.authentication.isAuth\" class=\"profile-menu\"><a href=\"\" toggle-submenu><div class=\"profile-pic\"><img data-ng-src=\"{{tcmsctrl.authentication.userInfo.Avatar}}\" alt=\"\"></div><div class=\"profile-info\">{{tcmsctrl.authentication.userInfo.DisplayName}} <i class=\"zmdi zmdi-caret-down\"></i></div></a><ul class=\"main-menu\"><li><a data-ui-sref=\"pages.profile.about({username: tcmsctrl.authentication.userName})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-account\"></i> View Profile</a></li><li><a href=\"\"><i class=\"zmdi zmdi-input-antenna\"></i> Privacy Settings</a></li><li><a href=\"\"><i class=\"zmdi zmdi-settings\"></i> Settings</a></li><li><a href=\"\" data-ng-click=\"tcmsctrl.logOut()\"><i class=\"zmdi zmdi-time-restore\"></i> Logout</a></li></ul></div><ul class=\"main-menu\"><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-home\"></i> Dash Board</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.league\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-globe-alt\"></i> Leagues</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.team\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-flag\"></i> Teams</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.player\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-run\"></i> Players</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"management.dashboard\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-puzzle-piece\"></i> Management</a></li></ul></div>"
  );
  ...
  $templateCache.put('wwwroot/app/template/sidebar-left.html',
    "<div class=\"sidebar-inner c-overflow\"><div data-ng-if=\"tcmsctrl.authentication.isAuth\" class=\"profile-menu\"><a href=\"\" toggle-submenu><div class=\"profile-pic\"><img data-ng-src=\"{{tcmsctrl.authentication.userInfo.Avatar}}\" alt=\"\"></div><div class=\"profile-info\">{{tcmsctrl.authentication.userInfo.DisplayName}} <i class=\"zmdi zmdi-caret-down\"></i></div></a><ul class=\"main-menu\"><li><a data-ui-sref=\"pages.profile.about({username: tcmsctrl.authentication.userName})\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-account\"></i> View Profile</a></li><li><a href=\"\"><i class=\"zmdi zmdi-input-antenna\"></i> Privacy Settings</a></li><li><a href=\"\"><i class=\"zmdi zmdi-settings\"></i> Settings</a></li><li><a href=\"\" data-ng-click=\"tcmsctrl.logOut()\"><i class=\"zmdi zmdi-time-restore\"></i> Logout</a></li></ul></div><ul class=\"main-menu\"><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.wall\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-home\"></i> Home</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.league\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-globe-alt\"></i> Leagues</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.team\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-flag\"></i> Teams</a></li><li data-ui-sref-active=\"active\"><a data-ui-sref=\"pages.player\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-run\"></i> Players</a></li><li data-ng-if=\"tcmsctrl.authentication.isAdmin\" data-ui-sref-active=\"active\"><a data-ui-sref=\"management.posts\" data-ng-click=\"tcmsctrl.sidebarStat($event)\"><i class=\"zmdi zmdi-puzzle-piece\"></i> Management</a></li></ul></div>"
  );
