Giffy
    ...
    .controller('GiffyCtrl', ['$timeout', '$state', 'growlService', 'authService', '$scope', function ($timeout, $state, growlService, authService, $scope) {
        this.GiffyData = GiffyData;
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', function ($timeout, $rootScope, messageService, $state, $uibModal) {
        var _self = this;
         // Top Search
